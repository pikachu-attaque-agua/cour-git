...
#   https://github.com/Griefed/ServerPackCreator/blob/5.1.13/serverpackcreator-api/src/jvmMain/resources/de/griefed/resources/server_files/default_template.sh
#
...
echo "Start script generated by ServerPackCreator 5.1.13."
